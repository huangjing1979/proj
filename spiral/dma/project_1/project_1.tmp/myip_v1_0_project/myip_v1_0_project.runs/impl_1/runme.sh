...
HD_PWD='/home/node003/work/proj/spiral/dma/project_1/project_1.tmp/myip_v1_0_project/myip_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_v1_0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source myip_v1_0.tcl -notrace
