...
`timescale 1 ns / 1 ps
    ...
    (
        ...
        input wire [C_M_AXI_DATA_WIDTH-1:0] top_desc_ptr,
        input wire [C_M_AXI_DATA_WIDTH-1:0] bot_desc_ptr,

        input wire desc_fetch_start, // pulse signal
    ...
    reg [C_M_AXI_DATA_WIDTH-1:0] cur_desc_ptr;
    //reg [C_M_AXI_DATA_WIDTH-1:0] cur_src_ptr;
    reg [C_M_AXI_DATA_WIDTH-1:0] next_desc_ptr;
    reg                          desc_fetch_next;
           ...
           // state transition                                                          
            case (mst_exec_state)                                                       
              ...
              // AXI transaction when init_txn_pulse is asserted 
                if ( desc_fetch_start ) // pulse signal
                  begin                                                                 
                ...
                // issued until last_read signal is asserted.                           
                 ...
                 if (reads_done)                                                        
                   ...
                   begin                                                                
                     ...
                     if (~axi_arvalid && ~M_AXI_RVALID && ~last_read && ~start_single_read && ~read_issued && ~desc_fetch_halt)
                       begin                                                            
    ...
    begin
        ...
        else if (desc_fetch_start)
          cur_desc_ptr <= top_desc_ptr;
        else if (desc_fetch_next && (cur_desc_ptr != bot_desc_ptr))
    ...
    begin
        if (M_AXI_ARESETN == 0  || init_txn_pulse == 1'b1)                                                         
          next_desc_ptr <= 'h0;                                                            
        else if (M_AXI_RVALID && (cur_state == FETCH_DESC_WORD0))
          next_desc_ptr <= M_AXI_RDATA;
    end
